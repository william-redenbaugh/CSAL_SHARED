...
event_submission_t state_one_eventlist[] = {
    {state_one_event_one_function, TEST_EVENT_ONE, TEST_STATE_TWO},
    {state_one_event_two_function, TEST_EVENT_TWO, TEST_STATE_ONE},
    {state_one_event_three_function, TEST_EVENT_THREE, TEST_STATE_THREE},
    {NULL, NULL_EVENT, NULL_STATE},
};

event_submission_t state_two_eventlist[] = {
    {state_two_event_one_function, TEST_EVENT_ONE, TEST_STATE_ONE},
    {state_two_event_two_function, TEST_EVENT_TWO, TEST_STATE_TWO},
    {state_two_event_three_function, TEST_EVENT_THREE, TEST_STATE_THREE},
    {NULL, NULL_EVENT, NULL_STATE},
};

event_submission_t state_three_eventlist[] = {
    {state_three_event_one_function, TEST_EVENT_ONE, TEST_STATE_ONE},
    {state_three_event_two_function, TEST_EVENT_TWO, TEST_STATE_ONE},
    {state_three_event_three_function, TEST_EVENT_THREE, TEST_STATE_TWO},
    {NULL, NULL_EVENT, NULL_STATE},
};
